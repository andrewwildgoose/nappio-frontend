<script>
    ...
    onMount(() => {
        setTimeout(() => {
            animate = true;
        }, 2500); // Small delay before animation starts
    });
...
<style>
    ...
    /* Ensure elements start hidden and off-screen */
...
<div class="grid grid-cols-2 items-center justify-items-center m-10">
    <div 
        class="relative w-150 h-100 hidden"
