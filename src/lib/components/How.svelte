...
<div class="p-5 flex flex-col items-center justify-center text-center">
    ...
    <div class="m-5 p-5 bg-secondary max-w-2xl shadow-sm">
    ...
    <div class="m-5 p-5 bg-tertiary max-w-2xl shadow-sm">
    ...
    <div class="m-5 p-5 bg-accent max-w-2xl shadow-sm">
    ...
    <Button 
        ...
        class="bg-tertiary! hover:bg-text-colour! text-text-colour! hover:text-tertiary! font-ranchers text-3xl border-none rounded-none transition-colors duration-200 mt-5 p-8 shadow-sm"         size="lg"
        href="/subscribe"
    >
        Get Started
    </Button>
